...
public class Converter {
    ...
    // floorKey ищет наиболее близкое к нашему числу number. Причём снизу. тоесть 15 первое число снизу 10
    public String intToRoman(int number) {
        String roman = "";
        int arabianKey ;
        do {
            arabianKey = arabianKeyMap.floorKey(number); // вызываем у новой мапы метод floorKey в который передаём число
